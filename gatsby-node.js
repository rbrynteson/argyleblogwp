...
/**
 * This function creates the tag collection
 */
const createTagsPages = async ({ categories, gatsbyUtilities }) =>
    Promise.all(
        categories.map(category => {
            ...
            gatsbyUtilities.actions.createPage({
                ...
                path: `/tags/${_.kebabCase(category.fieldValue)}/`,
...
async function getCategories({ graphql, reporter }) {
    const graphqlResult = await graphql(/* GraphQL */ `
        query WpCategories {
            ...
            tagsGroup: allWpPost(limit: 2000) {
    ...
    return graphqlResult.data.tagsGroup.group;
}
